...
/*   Updated: 2023/01/17 15:09:57 by llord            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_cmd_block	*parse_line(char *line)
{
	...
	if (line && line[0])
	{
		...
		//FALSE, this doesn't acount for heredocs being commands
		cmdblock->cmd_count = ft_count_char(line, '|') + 1;		//breaks when pipe in quotes
